...
## astra_linux_special_edition_config.sh

Данный скрипт представляет реализацию моего видения настройки операционной системы Astra Linux Special Edition для соответствования требованиям документа "Руководящий документ. Автоматизированные системы. Защита от несанкционированного доступа к информации. Классификация автоматизированных систем и требования по защите информации", утвержденного решением председателя Государственной технической комиссии при Президенте Российской Федерации от 30.03.1992, по следующим классам защищенности:

- 1Б
- 1В
- 1Г

А так же установку некоторых других параметров Astra Linux Special Edition, не указанных в документе, но улучшающих показатели защищенности операционной системы
